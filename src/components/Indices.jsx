...
const indicesData = [
  { name: 'NIFTY', value: 17070.50, change: '+0.66%', history: [15050, 16060, 15070, 16010, 16070, 17010, 17050, 18080, 15010, 19050, 19180, 20130, 22450, 24990, 26789] },
  { name: 'BANK NIFTY', value: 39894.50, change: '-0.66%', history: [39900, 37850, 37800, 37850, 37880, 37810, 34830, 33750, 31650, 30550, 37880, 30810, 29830, 28750, 26650, 24550] },
  { name: 'SENSEX', value: 58074.65, change: '+0.66%', history: [15050, 16060, 15070, 16010, 16070, 17010, 17050, 18080, 15010, 19050, 19180, 20130, 22450, 24990, 26789] },
  { name: 'NIFTY500', value: 15877.40, change: '-0.05%', history: [39900, 37850, 37800, 37850, 37880, 37810, 34830, 33750, 31650, 30550, 37880, 30810, 29830, 28750, 26650, 24550] },
  { name: 'NIFTY500', value: 15877.40, change: '-0.05%', history: [39900, 37850, 37800, 37850, 37880, 37810, 34830, 33750, 31650, 30550, 37880, 30810, 29830, 28750, 26650, 24550] },
  { name: 'NIFTY500', value: 15877.40, change: '-0.05%', history: [39900, 37850, 37800, 37850, 37880, 37810, 34830, 33750, 31650, 30550, 37880, 30810, 29830, 28750, 26650, 24550] },
  { name: 'NIFTY500', value: 15877.40, change: '-0.05%', history: [39900, 37850, 37800, 37850, 37880, 37810, 34830, 33750, 31650, 30550, 37880, 30810, 29830, 28750, 26650, 24550] },
];
  ...
  return (
    <div className="relative flex flex-col w-[1128px] h-[205px] mt-[16px] ml-[16px] font-sans">
      <div className='flex flex-row justify-between mb-1 mx-[16px]'>
        <p className='font-bold h-[28px] text-gray-700'>Indices</p>
